...
async def run_scraper(
    url: str, output_dir: str, headless: bool = True, interact: bool = False
):
...
async def run_test_scenario(url: str, output_dir: str, scenario_file: str = None):
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        "-o",
        default="scripts/prototypes/output",
    ...
    if args.scenario:
        asyncio.run(run_test_scenario(args.url, args.output_dir, args.scenario))
    else:
        asyncio.run(
